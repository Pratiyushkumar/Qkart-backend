...
describe('Auth routes', () => {
  describe('POST /v1/auth/register', () => {
    ...
    it('should return token is valid for user', async () => {
      const res = await request(app).post('/v1/auth/register').send(newUser);
    ...
    it("should return 400 error if email field isn't present", async () => {
    ...
    it("should return 400 error if name field isn't present", async () => {
  ...
  describe('POST /v1/auth/login', () => {
    ...
    it('should return 400 error if email field isnt present', async () => {
      await insertUsers([userOne]);
      const loginCredentials = {
        password: userOne.password,
      };
