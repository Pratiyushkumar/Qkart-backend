...
describe('Product routes', () => {
  describe('GET /v1/products', () => {
    it('should return 200 and response object should be ok', async () => {
  ...
  describe('GET /v1/products/:productId', () => {
    it('should return 200 and the product object if data is ok', async () => {
    ...
    it('should return 401 when invalid Mongo Id is given', async () => {
      await insertProducts([productOne]);
